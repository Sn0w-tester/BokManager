...
if (!isset($_SESSION["admin"])) {
    // Nếu phiên làm việc không chứa thông tin admin, điều hướng về trang đăng nhập
    ?>
...
include "./conn.php"; // Bao gồm tệp kết nối cơ sở dữ liệu
...
if (isset($_POST["submit1"])) {
    ...
    log_activity(" $_SESSION[admin] Created a new bill with Bill No. $_POST[bill_no]");
