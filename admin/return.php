...
mysqli_query($link, "INSERT INTO return_products VALUES(NULL, '$bill_no', '$_SESSION[admin]', '$today_date', '$product_company', '$product_name', '$product_unit', '$packing_size', '$price', '$qty', '$total')");
